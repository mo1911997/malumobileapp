...
class _LandingScreenState extends State<LandingScreen> {
  ...
  getClientData() async {
    ...
    {
      nestedObject = i['clients'];
    }
    print(nestedObject);
    // hya nestedObject madhe tula list kadhun diliye final . Just list view builder la assign karun tula kasa show karaycha ahe tasa kar
    for(var x in nestedObject)
    {
      print(x['id']['name']);
    }// ithe to object last level paryant parse kelela ahe no need to use POJO in here .
